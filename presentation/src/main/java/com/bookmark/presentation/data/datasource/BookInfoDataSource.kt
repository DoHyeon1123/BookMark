package com.bookmark.presentation.data.datasource
...
class BookInfoDataSource  @Inject constructor(
    private val remote : com.bookmark.presentation.data.api.remote.BookInfoRemote,
    private val cache : BookCache,
){
    private val mapper = BookMapper()
    var list : List<Book> = listOf()

    fun searchBooks(query : String) : Call<com.bookmark.presentation.data.book.BookResponse>{
